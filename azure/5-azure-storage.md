...
| --------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | --------------------------------- |
| Data gets stored in underlying datacenter, and three copies will be made within the same Datacenter | Data gets replicate synchronously between three Azure availability zones. Each zone is separate physical location with independant power, cooling and networking. | Here data is replicated to another region (paired region)                                                         | --------------------------------- |
